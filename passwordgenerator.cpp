...
std::string PasswordGenerator::createPasswordShort()
{
    ...
    int intervalHighLimit = MIN_HSYMBOL + tempStrong - 1;
...
std::string PasswordGenerator::createPassword()
{
    ...
    int intervalNumberHighLimit = MIN_NSYMBOL + tempStrong - COUNT_HSYMBOL - 1;
...
std::string PasswordGenerator::createPasswordLong()
{
    ...
    int intervalLowerHighLimit = MIN_LSYMBOL + tempStrong - COUNT_HNSYMBOL - 1;
